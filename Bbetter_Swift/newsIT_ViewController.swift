...
class newsIT_ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    func crawl(){
                ...
                let url = URL(string: "https://news.daum.net/digital#1")
